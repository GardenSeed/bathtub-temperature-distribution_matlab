...
%设计公式
t_in = t_input;
t_in(1,1:12,1:10) = t_in(2,1:12,1:10);
t_in(22,1:12,1:10) = t_in(21,1:12,1:10);
t_in(1:22,1,1:10) = t_in(1:22,2,1:10);
t_in(1:22,12,1:10) = t_in(1:22,11,1:10);
t_in(1:22,1:12,1) = t_in(1:22,1:12,2);
